...
export default function PhoneButton({
  ...
  const mainClasses =
    "flex size-[175px] cursor-pointer items-center justify-center whitespace-pre rounded-full border-2 border-gray-200 bg-mred p-6 outline outline-[5px] outline-black transition-all duration-300 hover:bg-red hover:outline-[8px]";

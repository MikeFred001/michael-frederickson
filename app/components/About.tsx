...
export default function About() {
  return (
    <div className='ABOUT flex justify-between w-[74rem] py-10'>
      <div className='flex flex-col gap-2'>
        <Typography className='text-[6rem] text-shadow-red2 font-semibold leading-tight'>About</Typography>
        <Typography className='max-w-[48rem] text-[1.6rem] text-justify font-semibold'>
          ...
          I made the leap into tech in 2020 because I simply like creating cool stuff. Especially when it works well and looks good. <br />
          ...
          My background in office environments also gave me valuable skills in teamwork, communication, and time management. <br />
